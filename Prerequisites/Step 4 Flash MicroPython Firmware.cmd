...
@rem PSRAM Version
@rem pushd .\Firmware\MicroPython_LoBo_esp32_psram_all\esp32_psram_all

Echo non PSRAM version
pushd .\Firmware\MicroPython_LoBo_esp32_all\esp32_all

@rem : todo ask to erase flash 
@rem esptool.py --port COM5 erase_flash
