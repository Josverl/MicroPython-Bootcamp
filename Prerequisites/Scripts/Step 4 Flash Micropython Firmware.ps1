...
$SerialPort = Get-SerialPorts | Where Description -Like "USB-SERIAL CH340" | Select -First 1 -ExpandProperty Port
Write-Host -ForegroundColor Green "Selected Serial Port $SerialPort"
